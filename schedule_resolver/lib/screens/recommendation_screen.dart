        ...
        padding: const EdgeInsets.all(16.0),
          child: Column(
            children: [
              ...
              _buildSection(context, 'Ranked Tasks', analysis.rankedTasks, Color.fromARGB(255, 4, 4, 126), Icons.format_list_numbered),
              _buildSection(context, 'Recommendation Schedule', analysis.recommendedSchedule, Color.fromARGB(255, 4, 126, 8), Icons.calendar_today),
              _buildSection(context, 'Explanation', analysis.explanation, Color.fromARGB(255, 169, 69, 8), Icons.lightbulb_circle_outlined),
